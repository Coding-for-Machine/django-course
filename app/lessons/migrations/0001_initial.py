...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('input_data', models.CharField(help_text='Inputlar \\n bilan ajratilgan bo‘lishi kerak', max_length=200)),
                ('output_data', models.CharField(help_text='Output ma’lumotlari', max_length=200)),
